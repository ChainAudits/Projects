////////////////////////////////////
//
//  Welcome to Degen.Food
//  Web: https://degen.food
//  Telegram: https://t.me/DegenFood
//  X: https://x.com/degenfood
//
////////////////////////////////////
...
contract DegenFood is ERC20, Ownable {
    ...
    function updateBuyTax(uint256 _taxWithTwoDecimals) external onlyOwner {
        require(_taxWithTwoDecimals <= 500, "Keep tax below 5%");
    ...
    function updateSellTax(uint256 _taxWithTwoDecimals) external onlyOwner {
        require(
            _taxWithTwoDecimals <= sellTotalTax,
            "Keep tax below current tax"
        );
    ...
    function updateTaxAddress(address _address) external onlyOwner {
        ...
        require(msg.sender == tx.origin, "Contract cannot set a tax address");
        require(size == 0, "Tax address cannot be a contract");
